...
public class Item_3 {
	...
	public void tentativa_de_instanciar_IVs_ou_PSs_isoladamente() {
		...
		//IV item_de_venda = new Produto(); // Estas linha gerariam erro de compilação, pois
		//IV item_de_venda = new Servico(); // os construtores de Produto e Servico tem visibilidade
