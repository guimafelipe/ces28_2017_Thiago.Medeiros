...
public class SIAPJ {
	...
	public void criaReclamacao(IProcesso processo) {
		//1) Checa se o processo estah no formato correto
		...
		if (result==true){
			...
			//2.2 envia uma mensagem de e-mail para o usuario que o processo foi aceito 
			email.sendEmail(processo.getEmail(), "Processo aceito");
		}
		else
			//3) se estiver incorreto, ele envia uma mensagem de e-mail para o usuario informando os problemas.
